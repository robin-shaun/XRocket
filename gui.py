...
class GUI(QWidget):
    ...
    def text2speech(self,answer):
        wsParam = TTS_Ws_Param(APPID='5e2faa83', APIKey='58c05763b09a8d85d9a2f5645f981824',
            APISecret='1d83a8338cc3e0188c880b9ab514770e',
            Text=answer)
        tts(wsParam,self.answerfile)
...
'''        
    ...
    def sendTextAction(self):
        ...
        if self.sendState == 0:
            ...
            self.count = 0
            self.speech2text()
            s = '<img src="/home/robin/RockeX/gui/q.png" width="30" height="30" /><img src="/home/robin/RockeX/gui/voice.png" width="100" height="30"/>' + self.stt_result
            question = self.stt_result
